...
from ..database.models.postgres_models import MaUser, TTransaction,TTransactionitem,MPromotionBucketEntity,MPromotionHeader,MFileMaster,Minformationimport
from ..schemas.transaction import MachineInputRequest, DefectCreate, RemarkUpdate, CreateDefectRequest
...
def get_promotion_detail(pro_code: int,version:int=0, db: Session = Depends(get_db)):
...
# def search_items1(payload: ItemQueryRequest, db: Session = Depends(get_db_mysql)): # type: ignore
#     try:
