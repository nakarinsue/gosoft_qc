...
from app.backend.database.models.postgres_models import MVersionControl, MPromotionHeader, TTransaction,MaUser,MPromotionBucketEntity,MFileMaster,Minformationimport
from app.backend.schemas.transaction import DashboardSummary
...
@router.get("{version}/summary_promotion", response_model=DashboardSummary)
...
@router.get("{version}/show_promotion")
def get_promotion(
    version: int,
...
@router.get("{version}/testpro/{format}/{limit}")
