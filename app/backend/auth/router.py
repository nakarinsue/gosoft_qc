...
from .schemas import Token, UserResponse, UserCreate, UserUpdate, userassign
from .service import UserService
from .security import create_access_token,get_current_user

# สร้าง Router Instance ที่ถูกต้อง
...
# @router.get("/u", response_model=List[userassign])
# async def get_all_active_users(
#     _: dict = Depends(get_current_user),
#     db: Session = Depends(get_db)
# ):
#     """API สำหรับดึงข้อมูล User ทั้งหมดที่มีสถานะ Active และยังไม่ถูกลบ"""
#     return UserService.get_active_users(db)
